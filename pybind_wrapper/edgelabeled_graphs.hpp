...
void defineEdgeLabeledDirectedGraph(py::module& m, const std::string& typestr) {
    ...
    pyclass
        ...
        .def("has_edge_idx",    [](const Class& self, VertexIndex u, VertexIndex v) { return self.hasEdgeIdx(u, v); },
                                  py::arg("source index"), py::arg("destination index"))
        .def("has_edge_idx",    py::overload_cast<VertexIndex, VertexIndex, const EdgeLabel&>(&Class::hasEdgeIdx, py::const_),
...
void defineEdgeLabeledUndirectedGraph(py::module& m, const std::string& typestr) {
    ...
    pyclass
        ...
        .def("has_edge_idx",    [](const Class& self, VertexIndex v1, VertexIndex v2) { return self.hasEdgeIdx(v1, v2); },
                                          py::arg("vertex1 index"), py::arg("vertex2 index"))
        .def("has_edge_idx",    py::overload_cast<VertexIndex, VertexIndex, const EdgeLabel&>(&Class::hasEdgeIdx, py::const_),
