...
void defineEdgeLabeledDirectedGraph(py::module& m, const std::string& typestr) {
    ...
    pyclass
        ...
        .def("add_edge_idx",            py::overload_cast<VertexIndex, VertexIndex, const EdgeLabel&, bool>(&Class::addEdge),
                                          py::arg("source index"), py::arg("destination index"), py::arg("label"), py::arg("force")=false)
        .def("add_reciprocal_edge_idx", py::overload_cast<VertexIndex, VertexIndex, const EdgeLabel&, bool>(&Class::addReciprocalEdge),
                                          py::arg("source index"), py::arg("destination index"), py::arg("label"), py::arg("force")=false)
        .def("remove_edge_idx", py::overload_cast<VertexIndex, VertexIndex>(&Class::removeEdge),
                                  py::arg("source index"), py::arg("destination index"))
        .def("has_edge_idx",    [](const Class& self, VertexIndex u, VertexIndex v) { return self.hasEdge(u, v); },
                                  py::arg("source index"), py::arg("destination index"))
        .def("has_edge_idx",    py::overload_cast<VertexIndex, VertexIndex, const EdgeLabel&>(&Class::hasEdge, py::const_),
                                  py::arg("source index"), py::arg("destination index"), py::arg("label"))
        .def("remove_vertex_from_edgelist_idx", &Class::removeVertexFromEdgeList, py::arg("vertex index"))
        ...
        .def("set_edge_label_to", py::overload_cast<VertexIndex, VertexIndex, const EdgeLabel&, bool>(&Class::setEdgeLabel),
                                    py::arg("source index"), py::arg("destination index"), py::arg("new label"), py::arg("force")=false)
        .def("get_edge_label_of", py::overload_cast<VertexIndex, VertexIndex, bool>(&Class::getEdgeLabelOf, py::const_),
...
void defineEdgeLabeledUndirectedGraph(py::module& m, const std::string& typestr) {
    ...
    pyclass
        ...
        .def("has_edge_idx",    [](const Class& self, VertexIndex v1, VertexIndex v2) { return self.hasEdge(v1, v2); },
                                          py::arg("vertex1 index"), py::arg("vertex2 index"))
        .def("has_edge_idx",    py::overload_cast<VertexIndex, VertexIndex, const EdgeLabel&>(&Class::hasEdge, py::const_),
                                          py::arg("vertex1 index"), py::arg("vertex2 index"), py::arg("label"))
        .def("remove_vertex_from_edgelist_idx", &Class::removeVertexFromEdgeList, py::arg("vertex index"))
        .def("remove_duplicate_edges",  &Class::removeDuplicateEdges)
        .def("remove_selfloops",        &Class::removeSelfLoops)
        .def("clear_edges",             &Class::clearEdges)
