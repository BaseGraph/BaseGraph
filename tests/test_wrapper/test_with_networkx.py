...
bg_directed_graph = bg.io.load_directed_text_edgelist("tests/assets/directed_graph.txt")
nx_directed_graph = nx.read_edgelist("tests/assets/directed_graph.txt", create_using=nx.DiGraph)
bg_undirected_graph = bg.io.load_undirected_text_edgelist("tests/assets/undirected_graph.txt")
...
bg_small_directed_graph = bg.io.load_directed_text_edgelist("tests/assets/small_directed_graph.txt")
nx_small_directed_graph = nx.read_edgelist("tests/assets/small_directed_graph.txt", create_using=nx.DiGraph)
bg_small_undirected_graph = bg.io.load_undirected_text_edgelist("tests/assets/small_undirected_graph.txt")
