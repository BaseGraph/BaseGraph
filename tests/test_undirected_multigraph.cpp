...
TEST(UndirectedMultigraph, addMultiedge_existentSelfLoop_multiplicityIncremented) {
    BaseGraph::UndirectedMultigraph graph(3);
    graph.addEdge(0, 1);
    graph.addEdge(0, 0);
    graph.addEdge(0, 2);
...
TEST(UndirectedMultigraph, addMultiedge_existentMultiedgeAndForce_newMultiedge) {
    BaseGraph::UndirectedMultigraph graph(3);
    graph.addEdge(0, 1);
    graph.addEdge(0, 2);
    graph.addEdge(0, 0);
...
TEST(UndirectedMultigraph, removeMultiedge_existentEdgeWithHigherMultiplicity_multiplicityDecremented) {
    BaseGraph::UndirectedMultigraph graph(3);
    graph.addEdge(0, 1);
...
TEST(UndirectedMultigraph, removeMultiedge_existentEdgeWithEqualMultiplicity_noEdge) {
    BaseGraph::UndirectedMultigraph graph(3);
    graph.addEdge(0, 1);
    graph.addMultiedge(0, 2, 3);
    graph.addEdge(0, 0);
...
TEST(UndirectedMultigraph, removeMultiedge_existentEdgeWithLowerMultiplicity_noEdge) {
    BaseGraph::UndirectedMultigraph graph(3);
    graph.addEdge(0, 1);
    graph.addMultiedge(0, 2, 3);
    graph.addEdge(0, 0);
...
TEST(UndirectedMultigraph, removeMultiedge_existentSelfLoopWithHigherMultiplicity_multiplicityDecremented) {
    BaseGraph::UndirectedMultigraph graph(3);
    graph.addEdge(0, 1);
...
TEST(UndirectedMultigraph, removeMultiedge_existentSelfLoopWithEqualMultiplicity_noEdge) {
    BaseGraph::UndirectedMultigraph graph(3);
    graph.addEdge(0, 1);
    graph.addMultiedge(0, 0, 3);
    graph.addEdge(0, 2);
...
TEST(UndirectedMultigraph, removeMultiedge_existentSelfLoopWithLowerMultiplicity_noEdge) {
    BaseGraph::UndirectedMultigraph graph(3);
    graph.addEdge     (0, 1);
    graph.addMultiedge(0, 0, 3);
    graph.addEdge     (0, 2);
...
TEST(UndirectedMultigraph, setEdgeMultiplicity_inexistentEdgeToPositiveMultiplicity_addEdge) {
    BaseGraph::UndirectedMultigraph graph(3);
    graph.addEdge(0, 2);
...
TEST(UndirectedMultigraph, setEdgeMultiplicity_inexistentEdgeToMultiplicity0_doNothing) {
    BaseGraph::UndirectedMultigraph graph(3);
    graph.addEdge(0, 2);
...
TEST(UndirectedMultigraph, setEdgeMultiplicity_existentEdgeToMultiplicity0_removeEdge) {
    BaseGraph::UndirectedMultigraph graph(3);
    graph.addEdge(0, 2, 1);
    graph.addEdge(0, 1, 1);
    graph.addEdge(0, 0);
...
TEST(UndirectedMultigraph, setEdgeMultiplicity_existentEdgeToNonZeroMultiplicity_multiplicityAndEdgeNumberUpdated) {
    BaseGraph::UndirectedMultigraph graph(3);
    graph.addEdge(0, 2);
    graph.addEdge(0, 1);
    graph.addEdge(0, 0);
...
TEST(UndirectedMultigraph, setEdgeMultiplicity_vertexOutOfRange_throwOutOfRange) {
    BaseGraph::UndirectedMultigraph graph(0);
...
TEST(UndirectedMultigraph, getEdgeMultiplicity_vertexOutOfRange_throwOutOfRange) {
    BaseGraph::UndirectedMultigraph graph(0);
