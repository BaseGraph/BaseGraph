...
TYPED_TEST(testEdgeLabeledUndirectedGraph, edgeListConstructor_anyContainer_allEdgesExist) {
...
TYPED_TEST(testEdgeLabeledUndirectedGraph_integral, edgeListConstructor_anyContainer_correctTotalEdgeNumber) {
