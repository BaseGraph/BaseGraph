...
class CharEdgeLabeledDirectedGraph : public ::testing::Test {
  public:
    BaseGraph::EdgeLabeledDirectedGraph<unsigned char> graph =
        BaseGraph::EdgeLabeledDirectedGraph<unsigned char>(6);
...
class CharEdgeLabeledUndirectedGraph : public ::testing::Test {
  public:
    BaseGraph::EdgeLabeledUndirectedGraph<unsigned char> graph =
        BaseGraph::EdgeLabeledUndirectedGraph<unsigned char>(6);
    std::list<std::tuple<size_t, size_t, unsigned char>> edges = {
        {1, 3, 'b'}, {1, 4, 'a'}, {1, 5, 'c'}, {2, 3, 'g'},
        {2, 4, 'f'}, {2, 5, 'e'}, {3, 4, 'd'}, {4, 5, 'c'}};
    size_t edgeValueSum = 0;
...
TEST(DirectedTextEdgeList, writeAndLoadGraph_allEdgesExist) {
    ...
    auto loadedGraph_vertices =
        BaseGraph::io::loadDirectedTextEdgeList("testGraph_tmp.txt");
...
TEST(DirectedBinaryEdgeList, writeAndLoadGraph_allEdgesExist) {
    ...
    BaseGraph::DirectedGraph loadedGraph =
        BaseGraph::io::loadDirectedBinaryEdgeList("testGraph_tmp.bin");
...
TEST(DirectedBinaryEdgeList, inexistentFile_throwRuntimeError) {
    EXPECT_THROW(BaseGraph::io::loadDirectedBinaryEdgeList("\0"),
                 runtime_error);
}
...
TEST(UndirectedTextEdgeList, writeAndLoadGraph_allEdgesExist) {
    ...
    BaseGraph::io::writeTextEdgeList(graph, "testGraph_tmp.txt");
    auto loadedGraph_vertices =
        BaseGraph::io::loadUndirectedTextEdgeList("testGraph_tmp.txt");
    auto &loadedGraph = loadedGraph_vertices.first;
...
TEST(UndirectedTextEdgeList, inexistentFile_throwRuntimeError) {
    EXPECT_THROW(BaseGraph::io::loadUndirectedTextEdgeList("\0"),
                 runtime_error);
}
...
TEST(UndirectedBinaryEdgeList, writeAndLoadGraph_allEdgesExist) {
    ...
    BaseGraph::UndirectedGraph loadedGraph =
        BaseGraph::io::loadUndirectedBinaryEdgeList("testGraph_tmp.bin");
...
TEST(UndirectedBinaryEdgeList, inexistentFile_throwRuntimeError) {
    EXPECT_THROW(BaseGraph::io::loadUndirectedBinaryEdgeList("\0"),
                 runtime_error);
}

TEST_F(CharEdgeLabeledDirectedGraph,
       writingEdgesToBinaryAndLoadingThem_graphContainsAllEdges) {
    BaseGraph::io::writeBinaryEdgeList(graph, "verticesList_tmp.bin");
    auto loadedGraph =
        BaseGraph::io::loadLabeledDirectedBinaryEdgeList<unsigned char>(
...
TEST(DirectedBinaryLabeledEdgeList, inexistentFile_throwRuntimeError) {
    EXPECT_THROW(
        BaseGraph::io::loadLabeledDirectedBinaryEdgeList<unsigned char>("\0"),
        runtime_error);
}
...
TEST_F(CharEdgeLabeledUndirectedGraph,
    ...
    BaseGraph::io::writeBinaryEdgeList(graph, "verticesList_tmp.bin");
    auto loadedGraph =
        BaseGraph::io::loadLabeledUndirectedBinaryEdgeList<unsigned char>(
            "verticesList_tmp.bin");
...
TEST(UndirectedTextLabeledEdgeList, inexistentFile_throwRuntimeError) {
    EXPECT_THROW(
        BaseGraph::io::loadLabeledUndirectedBinaryEdgeList<unsigned char>("\0"),
        runtime_error);
}
