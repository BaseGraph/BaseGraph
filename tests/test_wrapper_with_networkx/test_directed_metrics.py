...
def test_undirected_local_clustering(directed_fixture):
    eq_all_vertices(
        directed_fixture,
        _metrics.get_undirected_local_clustering_coefficients,
...
def test_undirected_global_clustering(directed_fixture):
    approx(
        directed_fixture,
        _metrics.get_undirected_global_clustering_coefficient,
