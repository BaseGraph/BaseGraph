...
template<typename EdgeLabel>void writeBinaryEdgeList(const EdgeLabeledDirectedGraph<EdgeLabel>& graph, const std::string& fileName);

void writeTextEdgeList(const UndirectedGraph& graph, const std::string& fileName);
...
void writeBinaryEdgeList(const EdgeLabeledDirectedGraph<EdgeLabel>& graph, const std::string& fileName) {
    ...
    for (auto vertex: graph)
        for (auto neighbour: graph.getOutEdgesOf(vertex)) {
            ...
            writeBinaryValue(fileStream, graph.getEdgeLabelOf(vertex, neighbour));
        }
}

template<typename EdgeLabel>
void writeBinaryEdgeList(const EdgeLabeledUndirectedGraph<EdgeLabel>& graph, const std::string& fileName) {
    static_assert(!std::is_same<EdgeLabel, std::string>::value, "No implementation of string to write binary file");
...
template<typename EdgeLabel>
EdgeLabeledDirectedGraph<EdgeLabel> loadLabeledDirectedBinaryEdgeList(const std::string& fileName) {
...
template<typename EdgeLabel>
EdgeLabeledUndirectedGraph<EdgeLabel> loadLabeledUndirectedBinaryEdgeList(const std::string& fileName) {
    static_assert(!std::is_same<EdgeLabel, std::string>::value, "No implementation of string to read binary file");
