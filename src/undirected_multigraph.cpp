...
void UndirectedMultigraph::addMultiedge(VertexIndex vertex1,
                                        VertexIndex vertex2,
...
void UndirectedMultigraph::removeMultiedge(VertexIndex vertex1,
                                           VertexIndex vertex2,
                                           EdgeMultiplicity multiplicity) {
    assertVertexInRange(vertex1);
    assertVertexInRange(vertex2);
...
void UndirectedMultigraph::setEdgeMultiplicity(VertexIndex vertex1,
                                               VertexIndex vertex2,
                                               EdgeMultiplicity multiplicity) {
    assertVertexInRange(vertex1);
    assertVertexInRange(vertex2);
...
EdgeMultiplicity
UndirectedMultigraph::getEdgeMultiplicity(VertexIndex vertex1,
...
size_t UndirectedMultigraph::getDegreeOf(VertexIndex vertex,
...
std::vector<size_t>
UndirectedMultigraph::getDegrees(bool countSelfLoopsTwice) const {
