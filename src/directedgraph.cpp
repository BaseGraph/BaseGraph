...
void DirectedGraph::addEdge(VertexIndex source, VertexIndex destination, bool force){
...
DirectedGraph DirectedGraph::getSubgraphOf(const std::unordered_set<VertexIndex>& vertices) const{
