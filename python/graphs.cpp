...
static void defineGraphs(py::module &m) {
    py::class_<DirectedGraph>(m, "DirectedGraph")
        ...
        .def("add_reciprocal_edge",
             py::overload_cast<VertexIndex, VertexIndex, bool>(
                 &DirectedGraph::addReciprocalEdge),
        ...
        .def("has_edge",
             py::overload_cast<VertexIndex, VertexIndex>(
                 &DirectedGraph::hasEdge, py::const_),
             py::arg("source index"), py::arg("destination index"))
        .def("remove_vertex_from_edgelist",
             &DirectedGraph::removeVertexFromEdgeList, py::arg("vertex index"))
        ...
        .def("get_out_edges_of", &DirectedGraph::getOutEdgesOf,
             py::arg("vertex index"))
        ...
        .def("get_in_degree_of", &DirectedGraph::getInDegreeOf,
             py::arg("vertex index"))
        .def("get_in_degrees", &DirectedGraph::getInDegrees)
        .def("get_out_degree_of", &DirectedGraph::getOutDegreeOf,
             py::arg("vertex index"))
        .def("get_out_degrees", &DirectedGraph::getOutDegrees)

        .def("get_deep_copy",
             [](const DirectedGraph &self) { return DirectedGraph(self); })
        .def("get_undirected_graph",
             [](const DirectedGraph &self) { return UndirectedGraph(self); })
        .def("get_reversed_graph", &DirectedGraph::getReversedGraph)
        .def(
            "get_subgraph",
            [](const DirectedGraph &self,
               const std::vector<VertexIndex> &vertices) {
                return self.getSubgraphOf(vertices.begin(), vertices.end());
            },
        ...
        .def(
            ...
            [](const DirectedGraph &self,
               const std::vector<VertexIndex> &vertices) {
                return self.getSubgraphWithRemapOf(vertices.begin(),
                                                   vertices.end());
            },
            py::arg("subgraph vertices"))
        ...
        .def(
            "__eq__",
            [](const DirectedGraph &self, const DirectedGraph &other) {
                return self == other;
            },
            py::is_operator())
        .def(
            ...
            py::is_operator())
        .def("__getitem__",
             [](const DirectedGraph self, VertexIndex idx) {
        ...
        .def("__len__",
             [](const DirectedGraph self) { return self.getSize(); });

    py::class_<DirectedGraph::Edges>(m, "DirectedEdgeIterator")
        .def("__iter__", [](const DirectedGraph::Edges &self) {
            return py::make_iterator(self.begin(), self.end());
        });
    ...
    py::class_<UndirectedGraph>(m, "UndirectedGraph")
        ...
        .def(
            "resize",
            [&](UndirectedGraph &self, size_t size) { self.resize(size); },
            py::arg("size"))
        .def("get_size", [&](UndirectedGraph &self) { return self.getSize(); })
        .def("get_edge_number",
             [&](UndirectedGraph &self) { return self.getEdgeNumber(); })
        ...
        .def("has_edge",
             py::overload_cast<VertexIndex, VertexIndex>(
                 &UndirectedGraph::hasEdge, py::const_),
             py::arg("vertex1 index"), py::arg("vertex2 index"))
        .def("remove_edge",
             py::overload_cast<VertexIndex, VertexIndex>(
        ...
        .def("remove_self_loops",
             [&](UndirectedGraph &self) { self.removeSelfLoops(); })
        .def("clear_edges", [&](UndirectedGraph &self) { self.clearEdges(); })

        .def("get_neighbours_of", &UndirectedGraph::getNeighboursOf,
             py::arg("vertex index"))
        .def("get_out_edges_of", &UndirectedGraph::getNeighboursOf,
             py::arg("vertex index"))
        .def("get_edges", &UndirectedGraph::getEdges)
        .def("get_adjacency_matrix", &UndirectedGraph::getAdjacencyMatrix)
        .def("get_degree_of", &UndirectedGraph::getDegreeOf,
             py::arg("vertex index"), py::arg("with self-loops") = true)
        .def("get_degrees", &UndirectedGraph::getDegrees,
             py::arg("with self-loops") = true)

        .def("get_directed_graph", &UndirectedGraph::getDirectedGraph)
        .def("get_deep_copy",
             [](const UndirectedGraph &self) { return UndirectedGraph(self); })
        .def(
            "get_subgraph",
        ...
        .def(
            "__eq__",
            [](const UndirectedGraph &self, const UndirectedGraph &other) {
                return self == other;
            },
            py::is_operator())
        .def(
            ...
            py::is_operator())
        .def("__getitem__",
             [](const UndirectedGraph self, VertexIndex idx) {
                 return self.getOutEdgesOf(idx);
             })
        .def("__str__",
             [](const UndirectedGraph self) {
        ...
        .def(
            ...
            py::keep_alive<
                ...
                1>() /* Essential: keep object alive while iterator exists */)
        .def("__len__",
             [](const UndirectedGraph self) { return self.getSize(); });

    py::class_<UndirectedGraph::Edges>(m, "UndirectedEdgeIterator")
        .def("__iter__", [](const UndirectedGraph::Edges &self) {
            return py::make_iterator(self.begin(), self.end());
        });
}
...
static void defineMultigraphs(py::module &m) {
    ...
    py::class_<DirectedMultigraph, EdgeLabeledDirectedGraph<EdgeMultiplicity>>(
        m, "DirectedMultigraph")
        .def(py::init<size_t>(), py::arg("size"))

        .def("add_edge",
             py::overload_cast<VertexIndex, VertexIndex, bool>(
                 &DirectedMultigraph::addEdge),
             py::arg("source"), py::arg("destination"),
             py::arg("force") = false)
        .def("remove_edge",
             py::overload_cast<VertexIndex, VertexIndex>(
                 &DirectedMultigraph::removeEdge),
             py::arg("source"), py::arg("destination"))
        .def(
            "add_multiedge",
    ...
    py::class_<UndirectedMultigraph,
               EdgeLabeledUndirectedGraph<EdgeMultiplicity>>(
        m, "UndirectedMultigraph")
        .def(py::init<size_t>(), py::arg("size"))

        .def("add_edge",
             py::overload_cast<VertexIndex, VertexIndex, bool>(
                 &UndirectedMultigraph::addEdge),
             py::arg("vertex1"), py::arg("vertex2"), py::arg("force") = false)
        .def("remove_edge",
             py::overload_cast<VertexIndex, VertexIndex>(
                 &UndirectedMultigraph::removeEdge),
