...
defineSpecializedEdgeLabeledDirectedGraph(
    py::class_<EdgeLabeledDirectedGraph<EdgeLabel>, DirectedGraph> &pyClass) {}
...
defineSpecializedEdgeLabeledDirectedGraph(
    ...
    pyClass.def("get_total_edge_number",
                [](const Class &self) { return self.getTotalEdgeNumber(); });
}

template <typename EdgeLabel>
typename std::enable_if<!std::is_integral<EdgeLabel>::value>::type
defineSpecializedEdgeLabeledUndirectedGraph(
    py::class_<EdgeLabeledUndirectedGraph<EdgeLabel>, UndirectedGraph>
        &pyClass) {}
...
void defineEdgeLabeledDirectedGraph(py::module &m, const std::string &typestr) {
    ...
    pyclass.def(py::init<size_t>(), py::arg("size"))
        ...
        .def("add_reciprocal_edge_idx",
             py::overload_cast<VertexIndex, VertexIndex, const EdgeLabel &,
                               bool>(&Class::addReciprocalEdge),
             py::arg("source index"), py::arg("destination index"),
             py::arg("label"), py::arg("force") = false)
        .def("remove_edge_idx",
             py::overload_cast<VertexIndex, VertexIndex>(&Class::removeEdge),
             py::arg("source index"), py::arg("destination index"))
        .def(
            "has_edge_idx",
            [](const Class &self, VertexIndex u, VertexIndex v) {
        ...
        .def("has_edge_idx",
             ...
             py::arg("source index"), py::arg("destination index"),
             py::arg("label"))
        .def("remove_vertex_from_edgelist_idx",
             &Class::removeVertexFromEdgeList, py::arg("vertex index"))
        ...
        //.def("get_undirected_graph", [](const Class& self) { return
        //EdgeLabeledUndirectedGraph<EdgeLabel>(self); })
...
template <typename EdgeLabel>
void defineEdgeLabeledUndirectedGraph(py::module &m,
    ...
    pyclass.def(py::init<size_t>(), py::arg("size"))
        ...
        .def(
            "has_edge_idx",
            [](const Class &self, VertexIndex v1, VertexIndex v2) {
                return self.hasEdge(v1, v2);
            },
            py::arg("vertex1 index"), py::arg("vertex2 index"))
        .def("has_edge_idx",
             py::overload_cast<VertexIndex, VertexIndex, const EdgeLabel &>(
        ...
        .def("get_edge_label_of",
             py::overload_cast<VertexIndex, VertexIndex, bool>(
                 &Class::getEdgeLabelOf, py::const_),
             py::arg("vertex1 index"), py::arg("vertex2 index"),
             py::arg("exception when inexistent") = true)

        .def("get_deep_copy", [](const Class &self) { return Class(self); })
        //.def("get_directed_graph", [](const Class& self) { return
        //self.getDirectedGraph(); })
